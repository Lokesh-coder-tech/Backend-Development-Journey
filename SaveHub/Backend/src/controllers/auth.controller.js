...
export const googleLogin = async (req, res) => {
  ...
  try {
    ...
    // Inside your googleLogin controller in auth.controller.js
    if (!user) {
      // Logic for a NEW user registering via Google
      user = await userModel.create({
        ...
        isGoogleUser: true,
        // You can add a default "bio" or "role" here for SaveHub
        bio: "Joined via the astral plane",
      });
    }
...
export const logoutUser = async (req, res) => {
    try {
        ...
        // Ensure the options (httpOnly, secure) match how you originally set it
